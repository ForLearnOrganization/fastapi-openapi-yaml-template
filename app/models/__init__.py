...
class GenerateTextRequest(BaseModel):
    ...
    prompt: str = Field(..., description="Text prompt for generation", min_length=1, max_length=1000)
    max_length: Optional[int] = Field(50, description="Maximum length of generated text", ge=1, le=500)
    temperature: Optional[float] = Field(1.0, description="Temperature for text generation", ge=0.1, le=2.0)
...
class WeatherRequest(BaseModel):
    ...
    country_code: Optional[str] = Field(None, description="ISO 3166 country code", min_length=2, max_length=2)
